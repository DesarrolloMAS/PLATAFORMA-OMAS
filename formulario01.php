...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['fileprov']) && $_FILES['fileprov']['error'] === UPLOAD_ERR_OK) {
        ...
        $uploadDir = '../archivos/generados/trabajos_proveedores/';
        ...
        $fileName = uniqid('proveedor_', true) . '_' . basename($_FILES['fileprov']['name']);
        $filePath = $uploadDir . $fileName;
    
        // Mover el archivo a la carpeta deseada
        if (move_uploaded_file($_FILES['fileprov']['tmp_name'], $filePath)) {
            echo "El archivo se ha guardado correctamente en: $filePath";
        } else {
...
if (!isset($_FILES['imagen'])) {
    ...
    if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === UPLOAD_ERR_OK) {
        $imagenPath = '../archivos/generados/evidencias/imagen_evidencia' . uniqid() . '.png';
        $imagenTmpPath = $_FILES['imagen']['tmp_name'];
    
        if (!move_uploaded_file($imagenTmpPath, $imagenPath)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidenciaImg = new Drawing();
    $imagenEvidenciaImg->setPath($imagenPath);
    $imagenEvidenciaImg->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidenciaImg->setCoordinates('A82'); // Ajusta la celda donde quieres la imagen
    $imagenEvidenciaImg->setWorksheet($sheet);
    }
    ...
    if (isset($_FILES['imagen_1']) && $_FILES['imagen_1']['error'] === UPLOAD_ERR_OK) {
        $imagen_1Path = '../archivos/generados/evidencias/imagen_evidencia_1' . uniqid() . '.png';
        $imagen_1TmpPath = $_FILES['imagen_1']['tmp_name'];
    
        if (!move_uploaded_file($imagen_1TmpPath, $imagen_1Path)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidencia_1Img = new Drawing();
    $imagenEvidencia_1Img->setPath($imagen_1Path);
    $imagenEvidencia_1Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia_1Img->setCoordinates('A97'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia_1Img->setWorksheet($sheet);
    }
    ...
    if (isset($_FILES['imagen_2']) && $_FILES['imagen_2']['error'] === UPLOAD_ERR_OK) {
        $imagen_2Path = '../archivos/generados/evidencias/imagen_evidencia_2' . uniqid() . '.png';
        $imagen_2TmpPath = $_FILES['imagen_2']['tmp_name'];
    
        if (!move_uploaded_file($imagen_2TmpPath, $imagen_2Path)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidencia_2Img = new Drawing();
    $imagenEvidencia_2Img->setPath($imagen_2Path);
    $imagenEvidencia_2Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia_2Img->setCoordinates('A113'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia_2Img->setWorksheet($sheet);
    }
    ...
    if (isset($_FILES['imagen_3']) && $_FILES['imagen_3']['error'] === UPLOAD_ERR_OK) {
        $imagen_3Path = '../archivos/generados/evidencias/imagen_evidencia_3' . uniqid() . '.png';
        $imagen_3TmpPath = $_FILES['imagen_3']['tmp_name'];
    
        if (!move_uploaded_file($imagen_3TmpPath, $imagen_3Path)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidencia_3Img = new Drawing();
    $imagenEvidencia_3Img->setPath($imagen_3Path);
    $imagenEvidencia_3Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia_3Img->setCoordinates('A135'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia_3Img->setWorksheet($sheet);
    }
...
// IMAGEN 2
    ...
    if (isset($_FILES['imagen2']) && $_FILES['imagen2']['error'] === UPLOAD_ERR_OK) {
        $imagen2Path = '../archivos/formularios/imagen_evidencia2' . uniqid() . '.png';
        $imagen2TmpPath = $_FILES['imagen2']['tmp_name'];
    
        if (!move_uploaded_file($imagen2TmpPath, $imagen2Path)) {
            die("Error al guardar la imagen 2 de evidencia.");
        }
    $imagenEvidencia2Img = new Drawing();
    $imagenEvidencia2Img->setPath($imagen2Path);
    $imagenEvidencia2Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia2Img->setCoordinates('G82'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia2Img->setWorksheet($sheet);


    if (isset($_FILES['imagen2_1']) && $_FILES['imagen2_1']['error'] === UPLOAD_ERR_OK) {
        $imagen2_1Path = '../archivos/generados/evidencias/imagen_evidencia2_1' . uniqid() . '.png';
        $imagen2_1TmpPath = $_FILES['imagen2_1']['tmp_name'];
    
        if (!move_uploaded_file($imagen2_1TmpPath, $imagen2_1Path)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidencia2_1Img = new Drawing();
    $imagenEvidencia2_1Img->setPath($imagen2_1Path);
    $imagenEvidencia2_1Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia2_1Img->setCoordinates('G97'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia2_1Img->setWorksheet($sheet);
    }
    
    if (!isset($_FILES['imagen2_2'])) {
        die("Error: No se ha enviado ningún archivo.");
    }

    if (isset($_FILES['imagen2_2']) && $_FILES['imagen2_2']['error'] === UPLOAD_ERR_OK) {
        $imagen2_2Path = '../archivos/generados/evidencias/imagen_evidencia2_2' . uniqid() . '.png';
        $imagen2_2TmpPath = $_FILES['imagen2_2']['tmp_name'];
    
        if (!move_uploaded_file($imagen2_2TmpPath, $imagen2_2Path)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidencia2_2Img = new Drawing();
    $imagenEvidencia2_2Img->setPath($imagen2_2Path);
    $imagenEvidencia2_2Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia2_2Img->setCoordinates('G113'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia2_2Img->setWorksheet($sheet);
    }

    if (!isset($_FILES['imagen2_3'])) {
        die("Error: No se ha enviado ningún archivo.");
    }

    if (isset($_FILES['imagen2_3']) && $_FILES['imagen2_3']['error'] === UPLOAD_ERR_OK) {
        $imagen2_3Path = '../archivos/generados/evidencias/imagen_evidencia2_3' . uniqid() . '.png';
        $imagen2_3TmpPath = $_FILES['imagen2_3']['tmp_name'];
    
        if (!move_uploaded_file($imagen2_3TmpPath, $imagen2_3Path)) {
            die("Error al guardar la imagen de evidencia.");
        }
    $imagenEvidencia2_3Img = new Drawing();
    $imagenEvidencia2_3Img->setPath($imagen2_3Path);
    $imagenEvidencia2_3Img->setHeight(220); // Ajusta el tamaño según sea necesario
    $imagenEvidencia2_3Img->setCoordinates('G135'); // Ajusta la celda donde quieres la imagen
    $imagenEvidencia2_3Img->setWorksheet($sheet);
    }
