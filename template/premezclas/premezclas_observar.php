...
$sede = $_SESSION['sede'];
if ($sede === 'ZS'){
    $carpeta = rtrim(__DIR__, '/') . '/../../archivos/generados/premezclas/';
}else
    $carpeta = rtrim(__DIR__, '/') . '/../../archivos/generados/premezclas/';
...
$pdfCarpeta = $carpeta . '/../premezclas_pdfs/';
$pdfNombre = 'Premezcla_' . $nummolienda . '.pdf';
...
<body>
    <h1 class="titulo_principal">Vista Previa del Archivo Excel <a class="boton" href="premezclas_revisar.php">Volver</a></h1>
    <br><br><br><br><br>
    <a class="boton" href="premezclas_muestra.php?archivo=<?php echo urlencode($archivo); ?>">Corregir</a>
