...
$ruta_json = "../../../../archivos/generados/cert_apoyo_electrico/"
...
$periodo = str_replace(['ELEC_', '.json'], '', basename($target_file));
...
$CONTROLES_LABELS = [
    'desenergizacion' => 'Desenergización y/o aislamiento de energías',
    'evaluacion'      => 'Evaluación previa del riesgo',
    'atmosferas'      => 'Eliminación o control de atmósferas peligrosas',
    'caidas'          => 'Sistemas de protección contra caídas',
    'ignicion'        => 'Control de fuentes de ignición',
    'delimitacion'    => 'Delimitación y señalización del área',
    'vigilancia'      => 'Vigilancia y monitoreo continuo',
    'epp'             => 'Uso correcto de EPP crítico',
    'competencia'     => 'Competencia y capacitación del personal',
    'emergencia'      => 'Plan de emergencia y rescate',
];
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Riesgo Eléctrico — <?= htmlspecialchars($periodo) ?></title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
    <style>
        :root { --navy:#0F172A; --blue:#003366; --white:#FFFFFF; --border:#000; --elec:#B45309; }
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .btn-back:hover { background:rgba(234,179,8,0.1); }
        .doc-label { color:#E2E8F0; font-size:13px; font-weight:600; padding:0 8px; border-left:2px solid #EAB308; }
        .btn-print {
        ...
        .ctrl-row:nth-child(even) td { background:#FFFBEB; }
...
<div class="action-bar">
    <div class="left">
        <a href="rev_riesgo_electrico.php" class="btn-back">← Listado</a>
...
<div class="registro-block">
    ...
    <table class="header-table" style="margin-bottom:0;">
        <tr>
            ...
            <td style="width:60%;text-align:center;padding:10px;">
                ...
                <div class="header-title-doc">CERTIFICADO DE APOYO — TRABAJO RIESGO ELÉCTRICO</div>
            ...
            <td style="width:22%;padding:0;vertical-align:top;">
                <table class="iso-meta" style="height:100%;">
                    <tr><td>Código:</td><td>HSEQ-CA-ELEC-001</td></tr>
    ...
    <table style="margin-top:0;">
        ...
        <tr>
            ...
            <td class="val" colspan="5"><?= htmlspecialchars($d['dependencia'] ?? '—') ?></td>
        </tr>
        <tr>
