...
$target_dir   = "../../../../archivos/generados/cert_apoyo_caliente/" . $sede_saneada . "/";
...
if (file_exists($target_dir)) {
    foreach (scandir($target_dir) as $file) {
        ...
        $archivos[] = [
            'filename'       => $file,
            'periodo'        => str_replace(['CAL_', '.json'], '', $file),
            'registros'      => $total,
...
<head>
    ...
    <title>Revisiones — Trabajo en Caliente</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <h1 class="main-title">🔥 Trabajo en Caliente — Certificados</h1>
    ...
    <div class="grid" id="gridContainer">
        ...
        <?php else: ?>
            <?php foreach ($archivos as $doc): ?>
                <a href="visor_trabajo_caliente.php?file=<?= urlencode($doc['filename']) ?>"
                   class="file-card"
