...
$ruta_json = "../../../../archivos/generados/cert_apoyo_caliente/"
...
$periodo = str_replace(['CAL_', '.json'], '', basename($target_file));
...
$CONTROLES_LABELS = [
    'sustancias'      => 'Sitio libre de sustancias combustibles o inflamables',
    'lonas'           => 'Equipos y materiales cubiertos con lonas',
    'mamparas'        => 'Mamparas instaladas para aislar áreas vecinas',
    'extintores'      => 'Extintores adecuados dispuestos en el sitio de trabajo',
    'cables'          => 'Cables y conexiones de equipos en buenas condiciones',
    'instrucciones'   => 'Ejecutor recibió instrucciones y precauciones de la tarea',
    'epp'             => 'Elementos de protección personal apropiados disponibles',
    'otros_permisos'  => 'Consulta de otros permisos (alturas/espacios confinados)',
    'conocimiento'    => 'Ejecutor conoce el equipo y los procedimientos del permiso',
    'otros_controles' => 'Otros controles requeridos según la actividad',
];
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Trabajo en Caliente — <?= htmlspecialchars($periodo) ?></title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
    <style>
        :root { --navy:#0F172A; --blue:#003366; --orange:#B45309; --white:#FFFFFF; --border:#000; --accent:#FFB000; }
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .btn-back:hover { background:rgba(255,176,0,0.1); }
        ...
        tfoot td { background:#FFF8E1; font-weight:700; font-size:7.5pt; border-top:2px solid var(--orange); padding:5px 8px; }
...
<div class="action-bar">
    <div class="left">
        <a href="rev_trabajo_caliente.php" class="btn-back">← Listado</a>
    ...
    <table class="header-table" style="margin-bottom:0;">
        <tr>
            ...
            <td style="width:60%;text-align:center;padding:10px;">
                ...
                <div class="header-title-doc">CERTIFICADO DE APOYO — TRABAJO EN CALIENTE</div>
            ...
            <td style="width:22%;padding:0;vertical-align:top;">
                <table class="iso-meta" style="height:100%;">
                    <tr><td>Código:</td><td>HSEQ-CA-CAL-001</td></tr>
