...
$ruta_json = "../../../../archivos/generados/cert_apoyo_espacios_conf/"
...
$periodo = str_replace(['ECC_', '.json'], '', basename($target_file));
...
$CONTROLES_LABELS = [
    ...
    'monitoreo'     => '¿Monitoreo continuo de la atmósfera?',
    'ventilacion'   => '¿Ventilación adecuada (natural o forzada)?',
    'senalizacion'  => '¿Área señalizada y delimitada?',
    'vias'          => '¿Vías de ingreso y salida seguras?',
    'loto'          => '¿Aislamiento de energías peligrosas (eléctrica, mecánica, hidráulica, neumática) – LOTO aplicado?',
    'equipos'       => '¿Equipos en buen estado y certificados?',
    'personal'      => '¿Personal autorizado y capacitado en espacios confinados?',
    'certificacion' => '¿Certificación vigente (si aplica)?',
    'epp'           => '¿Uso de EPP?',
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Espacios Confinados — <?= htmlspecialchars($periodo) ?></title>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" rel="stylesheet">
    <style>
        :root { --navy:#0F172A; --blue:#003366; --teal:#0E7490; --white:#FFFFFF; --border:#000; --accent:#00F0FF; }
...
<div class="action-bar">
    <div class="left">
        <a href="rev_espacios_confinados.php" class="btn-back">← Listado</a>
    ...
    <table class="header-table" style="margin-bottom:0;">
        <tr>
            ...
            <td style="width:60%;text-align:center;padding:10px;">
                ...
                <div class="header-title-doc">CERTIFICADO DE APOYO — ESPACIOS CONFINADOS</div>
            ...
            <td style="width:22%;padding:0;vertical-align:top;">
                <table class="iso-meta" style="height:100%;">
                    <tr><td>Código:</td><td>HSEQ-CA-CONF-001</td></tr>
