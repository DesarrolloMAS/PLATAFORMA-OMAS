...
$ruta_json = "../../../../archivos/generados/cert_apoyo_izaje/"
...
$periodo = str_replace(['IZAJ_', '.json'], '', basename($target_file));
...
$CONTROLES_LABELS = [
    'plan_izaje'        => 'Plan de izaje aprobado',
    'peso_carga'        => 'Verificación del peso de la carga',
    'inspeccion_equipo' => 'Inspección de equipos de izaje',
    'capacidad_carga'   => 'Capacidad de carga del equipo',
    'aparejos'          => 'Selección correcta de aparejos',
    'delimitacion'      => 'Delimitación del área de izaje',
    'terreno'           => 'Condiciones del terreno y estabilidad',
    'clima'             => 'Condiciones climáticas',
    'personal'          => 'Personal competente',
...
<head>
    ...
    <title>Izaje de Cargas — <?= htmlspecialchars($periodo) ?></title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .btn-back {
            background:transparent; border:1px solid #8B5CF6; color:#8B5CF6; text-decoration:none;
            padding:9px 18px; border-radius:4px; font-weight:700; font-size:12px; text-transform:uppercase; transition:all 0.2s;
        }
        .btn-back:hover { background:rgba(139,92,246,0.1); }
        .doc-label { color:#E2E8F0; font-size:13px; font-weight:600; padding:0 8px; border-left:2px solid #8B5CF6; }
        .btn-print {
        ...
        .ctrl-row:nth-child(even) td { background:#F5F3FF; }
...
<div class="action-bar">
    <div class="left">
        <a href="rev_izaje_cargas.php" class="btn-back">← Listado</a>
...
<div class="registro-block">
    ...
    <table class="header-table" style="margin-bottom:0;">
        <tr>
            ...
            <td style="width:60%;text-align:center;padding:10px;">
                ...
                <div class="header-title-doc">CERTIFICADO DE APOYO — TRABAJO IZAJE DE CARGAS</div>
            ...
            <td style="width:22%;padding:0;vertical-align:top;">
                <table class="iso-meta" style="height:100%;">
                    <tr><td>Código:</td><td>HSEQ-CA-IZAJ-001</td></tr>
    ...
    <table style="margin-top:0;">
        ...
        <tr class="firmas-hdr">
            <th style="width:12%;">Fecha</th><th style="width:25%;">Nombres y Apellidos</th>
            <th style="width:14%;">Cédula</th><th style="width:18%;">Cargo</th><th>Firma</th>
        </tr>
