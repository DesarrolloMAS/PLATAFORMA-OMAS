...
<head>
    ...
    <title>Revisiones — Trabajo en Alturas</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <h1 class="main-title">Trabajo en Alturas — Certificados</h1>
    ...
    <div class="grid" id="gridContainer">
        ...
        <?php else: ?>
            <?php foreach ($archivos as $doc): ?>
                <a href="visor_trabajo_alturas.php?file=<?= urlencode($doc['filename']) ?>"
                   class="file-card"
