...
<head>
    ...
    <h1 class="titulo_principal">Turno 2     <a class="botonvolver" href="molienda_ZS.php">Volver</a></h1>
    <script src="./formulario02.js" defer></script>
</head>
<body class="cuerpo" >
    <form action="./formulario02c_zs.php" method="post" id="formulario2" class="formulario2">
...
<div class="control">
    ...
    <label class="labelmen">
        ...
        <div>
                    ...
                    <input type="text" id="lote1o" name="lote10" placeholder="Ejemplo: 211124B">
                    <label>Resultado:</label>
                    <div class="result" id="resultado10">0</div>
                    <div>
                                    <label class="labelmen">
