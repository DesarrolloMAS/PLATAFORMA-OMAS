...
$pdfNombre = 'Control_Molienda_' . $nummolienda . '.pdf';
...
<body>
    <h1 class="titulo_principal">Vista Previa del Archivo Excel <a class="boton" href="./reformulario002.php">Volver</a></h1>
    <br><br><br><br><br>
