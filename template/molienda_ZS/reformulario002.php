...
if ($sede === 'ZS'){
    $carpeta =  __DIR__ . '/../../archivos/generados/excelC_MZS';
}else
    $carpeta =  __DIR__ . '/../../archivos/generados/excelC_M';
...
if (empty($archivos)) {
    die("No hay archivos Excel disponibles en la carpeta.");
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="/fmt/css/revision.css"><!-- Asegúrate de tener estilos -->
</head>
<body class="body">
    ...
    <div class="menu">
        <?php foreach ($archivos as $archivo): ?>
            <div class="file-card" >
                ...
                <a href="revisar2.php?archivo=<?php echo urlencode($archivo); ?>">Visualizar</a>
            </div>
        <?php endforeach; ?>
    </div>
    <br>
