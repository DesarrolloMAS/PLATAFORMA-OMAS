...
$target_dir   = "../../archivos/generados/cantidad_familiar/" . $sede_saneada . "/";
...
<head>
    ...
    <title>Revisiones - Control Cantidad Familiar</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <h1 class="main-title">Control de Cantidad Familiar</h1>
            <div class="sub-title">Sede: [ <?= htmlspecialchars($sede) ?> ] &nbsp;|&nbsp; Un archivo por producto</div>
        </div>
        <a href="../menu_produccion.html" style="text-decoration: none;" class="btn-back">← Volver</a>
    </div>
    ...
    <div class="search-bar">
        ...
        <a href="geleria_productos_familiar_v2.php" class="btn-new">
    ...
    <div class="grid" id="gridContainer">
        <?php if (empty($archivos)): ?>
            <div class="empty-state">
                ...
                <a href="geleria_productos_familiar_v2.php">+ Crear Primer Registro</a>
            </div>
        <?php else: ?>
            <?php foreach ($archivos as $doc): ?>
                <a href="visor_control_familiar_v2.php?file=<?= urlencode($doc['filename']) ?>"
                   class="file-card"
