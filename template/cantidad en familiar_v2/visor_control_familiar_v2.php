...
$ruta_json = "../../archivos/generados/cantidad_familiar/"
...
<div class="action-bar">
    <div class="left">
        <a href="rev_control_familiar_v2.php" class="btn-back">← Volver al Listado</a>
    ...
    <table class="header-table" style="margin-bottom:0;">
        <tr>
            ...
            <td style="width:60%; text-align:center; padding:10px;">
                ...
                <div class="header-title-main" style="margin-bottom:4px;">Control de Cantidad / Producto Familiar</div>
                <div class="header-title-doc"><?= htmlspecialchars($producto) ?> &nbsp;|&nbsp; Sede: <?= htmlspecialchars($sede) ?></div>
            </td>
            <td style="width:22%; padding:0; vertical-align:top;">
                <table class="iso-meta" style="height:100%;">
                    <tr><td>Código:</td><td>GP-PD-PP-CF-FO-001</td></tr>
    ...
    <table class="tabla-datos">
        ...
        <?php else: ?>
            ...
            <tr>
                ...
                <?php for ($i = 1; $i <= 10; $i++): ?>
                    <td><?= $bultos[$i] !== null ? number_format($bultos[$i], 3) : '—' ?></td>
                <?php endfor; ?>
