...
<head>
    ...
    <title>Galería de Productos — Control Familiar v2</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            ...
            <div class="sub-title">Control Familiar v2 &nbsp;|&nbsp; Sede: <?= htmlspecialchars($sede) ?></div>
        </div>
        <div class="header-actions">
            <a href="rev_control_familiar_v2.php" class="btn-rev">📋 Ver Revisiones</a>
        ...
        <?php foreach ($productos as $producto): ?>
            <div class="producto-card"
                ...
                <button class="btn-seleccionar"
                    onclick="window.location.href='control_familiar_v2.php?harina=<?= urlencode($producto) ?>'">
                    SELECCIONAR
                </button>
            </div>
        <?php endforeach; ?>
