...
<head>
    ...
    <title>LIBERACIONES PASTO</title>
</head>
</head>
<body class="body">
    <div>
    <form class="formulario" action="liberaciones_procesamiento.php" method="POST">
        <div class="contenedor_basico">
            ...
            <input type="hidden" name="planta" value="Zona Sur">
        </div>
        ...
        <h2>HARINAS PARA LIBERAR</h2>
            ...
            <div>
                ...
                <label class="labelmen" for="harina3">
                    HARINA DE TRIGO NARIÑO 2.500 G
                </label>
            </div>
            ...
            <div class="contenedor_harina" id="contenedor_harina3" style="display: none;">
                <div> 
                    ...
                    <select name="referencia_artesanal" id="harina3_referencia_2" onchange="handleCustomOption('harina3', 2)">
                        <option value="50 kg (20 UND)">50 kg (20 UND)</option>
            ...
            <div class="contenedor_harina" id="contenedor_harina4" style="display: none;">
                <div> 
                    ...
                    <select name="referencia4" id="referencia4">
                        <option value="50 KG (50 UND)">50 KG (50 UND)</option>
                    </select>
                    <label for="lote">Lote</label>
            ...
            <div class="contenedor_harina" id="contenedor_harina5" style="display: none;">
                <div> 
                    ...
                    <select name="referencia5" id="referencia5">
                        <option value="12.5 KG (25 UND)">12.5 KG (25 UND)</option>
                    </select>
                    <label for="lote">Lote</label>
            ...
            <div>
                 <!-- DIVISION ENTRE HARINAS -->
            <div>
            <input type="checkbox" id="harina12" onclick="botonharina12()">
                <label class="labelmen" for="harina12">
                    HARINA INTEGRAL
                </label>
            </div>
            <div id="contenedor_harina12_lotes">
            </div>
            <div class="contenedor_harina" id="contenedor_harina12" style="display: none;">
                <div> 
                    <label for="referencia12">Referencia</label>
                    <select name="referencia12" id="referencia12">
                        <option value="25 KG">25 KG</option>
                    </select>
                    <label for="lote12">Lote</label>
                    <input type="text" id="lote12" name="lote12" >
                    <label for="cantidad12">Cantidad Liberada</label>
                    <input type="number" id="cantidad12" name="cantidad12">
                </div>        
                <div>
                    <h2>AREA DE CUMPLIMIENTO</h2>
                    <label for="bitacora12">Cumple con especificaciones de FT o Bitacora de analisis</label>
                    <select name="bitacora12" id="bitacora12">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="panificacion12">Cumple los analisis de panificacion?</label>
                    <select name="panificacion12" id="panificacion12">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="laboratorios12">Cumple los analisis de laboratorios externos?</label>
                    <select name="laboratorios12" id="laboratorios12">
                        <option value="">---</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                        <option value="N/A">N/A</option>
                    </select>
                    <label for="fortificacion12">Cumple los adicion de fortificacion?</label>
                    <select name="fortificacion12" id="fortificacion12">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="mejorantes12">Cumple con adicion de mejorantes?</label>
                    <select name="mejorantes12" id="mejorantes12">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="empaque12">Cumple las condiciones y empaque rotulado?</label>
                    <select name="empaque12" id="empaque12">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="certificado12">Cumple el certificado de calidad?</label>
                    <select name="certificado12" id="certificado12">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <button type="button" onclick="agregarLote('harina12')">Agregar Lote</button>
                </div>
            </div>
            <!-- DIVISION ENTRE HARINAS -->
            <div>
            <input type="checkbox" id="harina13" onclick="botonharina13()">
                <label class="labelmen" for="harina13">
                    SEMOLA FINA
                </label>
            </div>
            <div id="contenedor_harina13_lotes">
            </div>
            <div class="contenedor_harina" id="contenedor_harina13" style="display: none;">
                <div> 
                    <label for="referencia13">Referencia</label>
                    <select name="referencia13" id="referencia_extrapan">
                        <option value="40 KG">40 KG</option>
                    </select>
                    <label for="lote13">Lote</label>
                    <input type="text" id="lote13" name="lote13" >
                    <label for="cantidad13">Cantidad Liberada</label>
                    <input type="number" id="cantidad13" name="cantidad13" >
                </div>        
                <div>
                    <h2>AREA DE CUMPLIMIENTO</h2>
                    <label for="bitacora13">Cumple con especificaciones de FT o Bitacora de analisis</label>
                    <select name="bitacora13" id="bitacora13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="panificacion13">Cumple los analisis de panificacion?</label>
                    <select name="panificacion13" id="panificacion13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="laboratorios13">Cumple los analisis de laboratorios externos?</label>
                    <select name="laboratorios13" id="laboratorios13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    ...
                    <label for="fortificacion13">Cumple los adicion de fortificacion?</label>
                    <select name="fortificacion13" id="fortificacion13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="mejorantes13">Cumple con adicion de mejorantes?</label>
                    <select name="mejorantes13" id="mejorantes13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="empaque13">Cumple las condiciones y empaque rotulado?</label>
                    <select name="empaque13" id="empaque13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <label for="certificado13">Cumple el certificado de calidad?</label>
                    <select name="certificado13" id="certificado13">
                        <option value="">---</option>
                        <option value="N/A">No Aplica</option>
                        <option value="Cumple">Cumple</option>
                        <option value="No Cumple">No Cumple</option>
                    </select>
                    <button type="button" onclick="agregarLote('harina13')">Agregar Lote</button>
                </div>
            </div>
...
<script>
        ...
        function botonharina12() {
            const checkbox = document.getElementById('harina12');
            const menu = document.getElementById('contenedor_harina12');
            menu.style.display = checkbox.checked ? 'block' : 'none';
        }
        function botonharina13() {
            const checkbox = document.getElementById('harina13');
            const menu = document.getElementById('contenedor_harina13');
            menu.style.display = checkbox.checked ? 'block' : 'none';
        }
