...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Procesar datos de NARIÑO 2.500 G
...
// Procesar datos de NARIÑO 1000g
...
// Procesar datos de HARINA NARIÑO 10KG
...
// Procesar datos de Harina ESPECIAL
...
// HARINA INTEGRAL
$sheet->setCellValue('B52', $_POST['referencia12'] ?? ''); // Referencia
$sheet->setCellValue('C52', $_POST['lote12'] ?? ''); // Lote
$sheet->setCellValue('D52', $_POST['cantidad12'] ?? ''); // Cantidad Liberada
$sheet->setCellValue('E52', $_POST['bitacora12'] ?? ''); // Cumple con especificaciones de FT
$sheet->setCellValue('F52', $_POST['panificacion12'] ?? ''); // Cumple análisis de panificación
$sheet->setCellValue('G52', $_POST['laboratorios12'] ?? ''); // Cumple análisis de laboratorios externos
$sheet->setCellValue('H52', $_POST['fortificacion12'] ?? ''); // Cumple adición de fortificación
$sheet->setCellValue('I52', $_POST['mejorantes12'] ?? ''); // Cumple con adición de mejorantes
$sheet->setCellValue('J52', $_POST['empaque12'] ?? ''); // Cumple condiciones y empaque
$sheet->setCellValue('K52', $_POST['certificado12'] ?? ''); // Cumple certificado de calidad

// HARINA SEMOLA FINA
$sheet->setCellValue('B56', $_POST['referencia13'] ?? ''); // Referencia
$sheet->setCellValue('C56', $_POST['lote13'] ?? ''); // Lote
$sheet->setCellValue('D56', $_POST['cantidad13'] ?? ''); // Cantidad Liberada
$sheet->setCellValue('E56', $_POST['bitacora13'] ?? ''); // Cumple con especificaciones de FT
$sheet->setCellValue('F56', $_POST['panificacion13'] ?? ''); // Cumple análisis de panificación
$sheet->setCellValue('G56', $_POST['laboratorios13'] ?? ''); // Cumple análisis de laboratorios externos
$sheet->setCellValue('H56', $_POST['fortificacion13'] ?? ''); // Cumple adición de fortificación
$sheet->setCellValue('I56', $_POST['mejorantes13'] ?? ''); // Cumple con adición de mejorantes
$sheet->setCellValue('J56', $_POST['empaque13'] ?? ''); // Cumple condiciones y empaque
$sheet->setCellValue('K56', $_POST['certificado13'] ?? ''); // Cumple certificado de calidad
