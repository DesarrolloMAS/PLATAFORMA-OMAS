...
use Mpdf\Mpdf;
$carpeta = rtrim(__DIR__, '/') . '/../../archivos/generados/excel_INS';
if (isset($_GET['archivo'])) {
    $archivo = $_GET['archivo'];
    $rutaArchivo = rtrim($carpeta, '/') . '/' . $archivo;
...
<body>
    <h1 class="titulo_principal">Vista Previa del Archivo Excel <a class="boton" href="revision_inspecciones.php">Volver</a></h1>
    <br><br><br><br><br>
    <a class="boton" href="procesar_inspecciones.php?archivo=<?php echo urlencode($archivo); ?>">Corregir</a>
