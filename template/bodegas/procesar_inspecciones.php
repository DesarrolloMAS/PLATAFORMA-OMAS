...
<form action="guardar_inspecciones.php" method="post">
    ...
    <div class="contenedorfirma">
            <label class="labelfir" for="canvasfirma1">Firma De Quien Realiza</label>
        ...
        <div class="contenedorfirma">
            <label class="labelfir" for="canvasfirma2">Firma De Quien verifica </label>
