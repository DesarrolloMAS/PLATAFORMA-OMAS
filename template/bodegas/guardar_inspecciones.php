...
$sede = $_SESSION['sede'];
if($sede === 'ZS'){
    $carpeta = __DIR__ . '/../../archivos/generados/excel_INS/';
}else{
    $carpeta = __DIR__ . '/../../archivos/generados/excel_INS/';
}
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['archivo']) && isset($_POST['data'])) {
    ...
    if (!file_exists($rutaArchivo)) {
        ...
        try {
            ...
            $celdasConFormula = ['B83','D83','F83','H83','J83','I11','B86','B87','B88','B89','B90'];
    ...
    if ($firmaturn1) {
        ...
        $firmaturn1Img->setCoordinates('A45'); // Asignar celda
    ...
    if ($firmaturn2) {
        ...
        $firmaturn2Img->setCoordinates('R45'); // Asignar celda
    ...
    if ($firmaturn4) {
        ...
        header("Location: revisar_inspecciones.php?archivo=" . urlencode($archivo));
    } catch (Exception $e) {
