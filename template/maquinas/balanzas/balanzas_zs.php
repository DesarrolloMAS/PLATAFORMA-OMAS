...
<body>
  ...
  <div>
    ...
    <img src="/img/MAQUINAS/Balanzas/Balanza_ZS.jpeg" alt="">
  </div>
  ...
  <div>
    <form action="maquinasave.php" method="POST">
      ...
      <div>
        ...
        <input type="text0" id="peso_utilizado" name="peso_utilizado" placeholder="Ingrese valor en gramos">
      </div>
      ...
      <input type="hidden" name="formato" value="verificacion_balanzas_ZS">
