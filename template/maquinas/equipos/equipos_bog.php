...
<body>
    ...
    <div>
        ...
        <img src="/fmt/img/MAQUINAS/Otros/equipo_bog.jpeg" alt="">
        <h4></h4>
    </div>

    <div>
        <form action="maquinasave.php" method="POST">
            <input type="hidden" name="codigo_maquina" value="<?php echo htmlspecialchars($_GET['codigo']); ?>">
            <input type="hidden" name="nombre_maquina" value="<?php echo htmlspecialchars($_GET['maquina']); ?>">
            <input type="hidden" name="zona" value="equipos">
            <input type="hidden" name="tipo_maquina" value="equipos">
            <input type="hidden" name="formato" value="equipos_bog"> <!-- o equipos_zs -->
