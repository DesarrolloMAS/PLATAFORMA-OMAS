...
<head>
  ...
  <title>Formulario Básculas</title>
</head>
<body>
  <h1>Básculas</h1>
  ...
  <div>
    ...
    <img src="/img/MAQUINAS/Basculas/Bascula_Pasto.jpeg" alt="">
  </div>
  ...
  <div>
    <form action="maquinasave.php" method="POST">
      ...
      <input type="hidden" name="tipo_maquina" value="bascula">
      ...
      <div>
        ...
        <img src="/fmt/img/MAQUINAS/Basculas/P1.jpeg" alt="">
      </div>
      ...
      <input type="hidden" name="formato" value="verificacion_basculas_ZS">
