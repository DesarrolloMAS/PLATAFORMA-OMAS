...
<head>
    ...
    <link rel="stylesheet" href="/fmt/css/maquinas.css">
...
<body>
    ...
    <div>
        ...
        <img src="/fmt/img/MAQUINAS/Imanes/iman_past.jpeg" alt="">
        <h4></h4>
    </div>
    ...
    <div>
        ...
        <input type="hidden" name="nombre_maquina" value="<?php echo htmlspecialchars($nombre_maquina); ?>">
            ...
            <div>
                <label for="Acopie">Acopie</label>
                <select name="Acopie" id="Acopie">
      ...
      <input type="hidden" name="formato" value="verificacion_iman_ZS">
