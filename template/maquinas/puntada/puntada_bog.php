...
<body>
    ...
    <div>
        ...
        <img src="/img/MAQUINAS/Puntada/puntada_Bog.jpg" alt="">
        <h4></h4>
    </div>
    ...
    <div>
        ...
        <input type="hidden" name="tipo_maquina" value="puntada">
            ...
            <div>
                <label for="Puntada">Puntada</label>
                <select name="Puntada" id="Puntada">
            ...
            <div>
                ...
                <select name="Lubricacion" id="Lubricacion">
                    <option value="Cumple">Cumple</option>
                    <option value="No cumple">No cumple</option>
                </select>
            </div>
