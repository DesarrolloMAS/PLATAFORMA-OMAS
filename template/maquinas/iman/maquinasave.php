...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $ruta_maquina = "/var/www//fmt/archivos/generados/verificaciones/Iman/{$codigo_maquina}-{$nombre_maquina}/";
    ...
    $directorio_imagenes = '/var/www/htdocs/fmt/img/MAQUINAS/Imanes/';
