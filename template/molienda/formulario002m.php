...
<head>
    ...
    <h1 class="titulo_principal">Turno 2     <a class="botonvolver" href="molienda.php">Volver</a></h1>
    <script src="./formulario02.js" defer></script>
</head>
<body class="cuerpo" >
    <form action="./formulario02m.php" method="post" id="formulario2" class="formulario2">
    ...
    <div class="residuo">
        <label class="resiudosec" for="residuoSelect1">Selecciona un tipo de Subproducto:</label>
            <select class="residuoselec" id="residuoSelect1" name="residuoSelect1" onchange="addResiduoFields1()">
                ...
                <option value="Salvado x25">Salvado x25</option>
                <option value="Salvado x30">Salvado x30</option>
                <option value="Mogolla x40">Mogolla x40</option>
                <option value="Segunda x50">Segunda x50</option>
                <option value="Semola Fina x25">Semola Fina x25</option>
                <option value="Semola Gruesa x25">Semola Gruesa x25</option>
                <option value="Germen x25">Germen x25</option>
