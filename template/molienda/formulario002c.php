...
<head>
    ...
    <h1 class="titulo_principal">Turno 3     <a class="botonvolver" href="molienda.php">Volver</a></h1>
    <script src="./formulario02.js" defer></script>
</head>
<body class="cuerpo" >
    <form action="./formulario02c.php" method="post" id="formulario2" class="formulario2">
