...
$sede = $_SESSION['sede'];
if($sede === 'ZC'){
    $carpeta = '/var/www/fmt/archivos/generados/control_cantidad/';
}else{
    $carpeta = '/var/www/fmt/archivos/generados/control_cantidad_zs/';
}
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['archivo']) && isset($_POST['data'])) {
    ...
    if ($firmaturn4) {
        ...
        header("Location: observar_cantidad_bulto.php?archivo=" . urlencode($archivo));
    } catch (Exception $e) {
