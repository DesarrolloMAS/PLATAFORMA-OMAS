...
<body>
    ...
    <div class="menu-revisiones-links">
        <a href="redireccion_jefatura.php">
        ...
        VOLVER AL MENU</a>
        <a href="./orden_mantenimiento/galeria.php">
        <span class="icon" aria-hidden="true">
    ...
    <a href="./orden_mantenimiento/ordenes_pendientes.php">
    <span class="icon" aria-hidden="true">
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#fee5b8" stroke-width="1.5">
    ...
    <a href="../template/liberaciones_mant/galeria_liberaciones.php">
    <span class="icon" aria-hidden="true">
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#fee5b8" stroke-width="1.5">
