...
$nuevo_registro = [
    'id_registro' => uniqid('INGCANTIDAD_'),
...
$base_dir     = "../../archivos/generados/inspeccion_control_cantidadzs/";
$sede_dir     = $base_dir . preg_replace('/[^A-Za-z0-9_-]/', '', $sede) . "/";
$archivo_json = $sede_dir . "INGCANTIDAD_" . $mes_actual . ".json";
...
if (@file_put_contents($archivo_json, json_encode($datos_existentes, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE))) {
    echo json_encode([
        'status'  => 'success',
        'message' => 'Inspección de control de cantidad registrada correctamente.',
