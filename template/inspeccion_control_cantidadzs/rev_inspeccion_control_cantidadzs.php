...
$target_dir = "../../archivos/generados/inspeccion_control_cantidadzs/" . $sede_dir . "/";
...
if (file_exists($target_dir)) {
    ...
    foreach ($files as $file) {
        ...
        $periodo = str_replace(['INGCANTIDAD_', '.json'], '', $file);
...
<head>
    ...
    <title>Revisiones - Inspección Control de Cantidad</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <h1 class="main-title">Inspección Control de Cantidad</h1>
            <div class="sub-title">Sede Operativa: [ <?= htmlspecialchars($sede) ?> ] &nbsp;|&nbsp; GP-PD-FP-GP-FO-012</div>
        </div>
    ...
    <div class="grid" id="gridContainer">
        <?php if (empty($archivos)): ?>
            <div class="empty-state">
                <h3>Sin Registros</h3>
                <p>Aún no hay inspecciones de control de cantidad guardadas para la sede <strong><?= htmlspecialchars($sede) ?></strong>.</p>
        ...
        <?php else: ?>
            ...
            ?>
                <a href="visor_inspeccion_control_cantidadzs.php?file=<?= urlencode($doc['filename']) ?>"
                   class="file-card"
                   data-search="<?= htmlspecialchars(strtolower($doc['periodo'] . ' ' . $doc['responsable'] . ' ' . $doc['ultimo_usuario'])) ?>">
                    ...
                    <div>
                        <div class="card-title">Control de Cantidad — <?= htmlspecialchars($doc['periodo']) ?></div>
