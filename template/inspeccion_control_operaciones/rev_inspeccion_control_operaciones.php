...
if (file_exists($target_dir)) {
    ...
    foreach ($files as $file) {
        ...
        $last_linea      = $ultimo['datos']['linea_produccion']             ?? 'Sin línea';
...
<head>
    ...
    <title>Revisiones - Inspección Control de Operaciones</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <h1 class="main-title">Inspección Control de Operaciones</h1>
    ...
    <div class="search-bar">
        <input type="text" class="search-input" id="searchInput"
               placeholder="Buscar por período o línea de producción..."
               oninput="filtrarTarjetas(this.value)">
        <a href="inspeccion_control_operaciones.html" class="btn-new">
    ...
    <div class="grid" id="gridContainer">
        <?php if (empty($archivos)): ?>
            <div class="empty-state">
                <h3>Sin Registros</h3>
                <p>Aún no hay inspecciones guardadas para la sede <strong><?= htmlspecialchars($sede) ?></strong>.</p>
                <a href="inspeccion_control_operaciones.html">+ Crear Primera Inspección</a>
            </div>
        <?php else: ?>
            ...
            ?>
                <a href="visor_inspeccion_control_operaciones.php?file=<?= urlencode($doc['filename']) ?>"
                   class="file-card"
                   data-search="<?= htmlspecialchars(strtolower($doc['periodo'] . ' ' . $doc['linea'])) ?>">
                    ...
                    <div>
                        <div class="card-title"><?= htmlspecialchars($doc['linea']) ?></div>
                        <div class="card-sub">Última inspección: <?= htmlspecialchars($doc['ultima_fecha']) ?></div>
                    </div>
