...
<head>
    ...
    <title>Revisiones - Inspección Gestión de la Producción</title>
...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <h1 class="main-title">Inspección Gestión de la Producción</h1>
            <div class="sub-title">Sede Operativa: [ <?= htmlspecialchars($sede) ?> ] &nbsp;|&nbsp; GP-PD-FP-GP-FO-016</div>
        </div>
    ...
    <div class="grid" id="gridContainer">
        <?php if (empty($archivos)): ?>
            <div class="empty-state">
                <h3>Sin Registros</h3>
                <p>Aún no hay inspecciones de gestión de la producción guardadas para la sede <strong><?= htmlspecialchars($sede) ?></strong>.</p>
        ...
        <?php else: ?>
            ...
            ?>
                <a href="visor_inspeccion_gestion_produccion_zs.php?file=<?= urlencode($doc['filename']) ?>"
                   class="file-card"
                   data-search="<?= htmlspecialchars(strtolower($doc['periodo'] . ' ' . $doc['responsable'] . ' ' . $doc['ultimo_usuario'])) ?>">
                    ...
                    <div>
                        <div class="card-title">Gestión de la Producción — <?= htmlspecialchars($doc['periodo']) ?></div>
