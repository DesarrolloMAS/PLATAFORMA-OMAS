...
<div class="container">
    ...
    <div class="header-box">
        <div>
            <div class="main-title">Control de Cantidad / Producto en Bulto</div>
            <span class="product-badge" id="productoBadge">Cargando producto...</span>
        </div>
        <a href="geleria_productos.php" class="btn-back">← Galería de Productos</a>
    </div>
    ...
    <form id="formBulto">
        ...
        <div class="section-card">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label for="peso_display">Peso del Producto (kg)</label>
                    <input type="text" id="peso_display" class="form-control" readonly>
                </div>
            </div>
        </div>
...
<script>
    ...
    const peso     = params.get('peso')   || '<?= htmlspecialchars($peso, ENT_QUOTES) ?>';

    document.getElementById('productoBadge').textContent = harina || 'Producto no especificado';
    document.getElementById('peso_display').value        = peso ? peso + ' kg' : '—';
    ...
    document.getElementById('formBulto').addEventListener('submit', async function(e) {
        e.preventDefault();
