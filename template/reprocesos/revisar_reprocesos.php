...
if ($sede === 'ZS'){
    ...
    $carpetapdf =  __DIR__ . '/../../archivos/generados/reprocesos_zs_pdf/';
}else
    $carpeta =  __DIR__ . '/../../archivos/generados/reprocesos_zc/';
    $carpetapdf =  __DIR__ . '/../../archivos/generados/reprocesos_zc_pdf/';
...
<body>
    <h1 class="titulo_principal">Vista Previa del Archivo Excel <a class="boton" href="galeria_reprocesos.php">Volver</a></h1>
    <br><br><br><br><br>
    <a class="boton" href="reprocesos_correccion.php?archivo=<?php echo urlencode($archivo); ?>">Corregir</a>
