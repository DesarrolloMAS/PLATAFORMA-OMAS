...
$zona=$_SESSION['sede'];
if ($zona === 'ZC'){
    $carpeta = realpath(__DIR__ . '/../../archivos/generados/empaque/');
    $pdfCarpeta = $carpeta . '/../empaque_pdf/';
}
else{
    $carpeta = realpath(__DIR__ . '/../../archivos/generados/empaque_zs/');
    $pdfCarpeta = $carpeta . '/../empaque_pdfzs/';
}
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['archivo'])) {
    ...
    try {
        ...
        header("Location: galeria_empaques.php");
        } catch (Exception $e) {
